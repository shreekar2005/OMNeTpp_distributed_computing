...
int GossipMessage::getOriginatorId() const
{
    return this->originatorId;
}

void GossipMessage::setOriginatorId(int originatorId)
{
    this->originatorId = originatorId;
}

const char * GossipMessage::getIpAddress() const
{
    return this->ipAddress.c_str();
}

void GossipMessage::setIpAddress(const char * ipAddress)
{
...
unsigned int GossipMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_originatorId
...
int GossipMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "originatorId") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "ipAddress") == 0) return baseIndex + 1;
...
std::string GossipMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    GossipMessage *pp = omnetpp::fromAnyPtr<GossipMessage>(object); (void)pp;
    switch (field) {
        case FIELD_originatorId: return long2string(pp->getOriginatorId());
...
void GossipMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    GossipMessage *pp = omnetpp::fromAnyPtr<GossipMessage>(object); (void)pp;
    switch (field) {
        case FIELD_originatorId: pp->setOriginatorId(string2long(value)); break;
...
omnetpp::cValue GossipMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    GossipMessage *pp = omnetpp::fromAnyPtr<GossipMessage>(object); (void)pp;
    switch (field) {
        case FIELD_originatorId: return pp->getOriginatorId();
...
void GossipMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    GossipMessage *pp = omnetpp::fromAnyPtr<GossipMessage>(object); (void)pp;
    switch (field) {
        case FIELD_originatorId: pp->setOriginatorId(omnetpp::checked_int_cast<int>(value.intValue())); break;
